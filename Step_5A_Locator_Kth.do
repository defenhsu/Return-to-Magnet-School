...
keep if grade_level == 1 | grade_level == 2 | grade_level == 0
...
drop if _merge == 2 
gen ontime_1st = grade_2017 == 1 
** retain>> didn't attend 1st grade on time
gen retained_2017 = grade_2017 == 0 
** skip one grade
gen ahead_2017 = grade_2017 == 2 
...
keep if grade_level == 2 | grade_level == 1 | grade_level == 3
...
gen retained_2018 = grade_2018 == 1 
gen ahead_2018 = grade_2018 == 3 
* this is student attrited if can't find her/his info on the later file
gen attrit_2nd = _merge == 1
drop _merge

save "$workingdata/Locator_Kth", replace
